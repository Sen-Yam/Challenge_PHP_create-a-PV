...
if(isset($_POST['boutton'])) {
	...
	foreach ($person as $p) {
		...
		$sql="INSERT INTO test3 VALUES('$p')";
...
<body style="background-color: rgb(231, 248, 243);">
    ...
    <h1>Entrer les points abordes dans la reunion</h1>
    <div class="perso" >
        <button id="h">Ajouter un point</button>
       <form action="tryphp4.php" class="f" method="post">
        <button class="btn" name="boutton">Continuer</button>
        <div id="i1">
            <div style=" margin-top: 40px; ">
                <input type="text" placeholder="point" name="point[]">
            </div>
...
<script>
        document.querySelector('#h').onclick= function(e) {
 		...
 		newspace.setAttribute("placeholder" , "point");
 		newspace.setAttribute("type" , "text");
 		newspace.classList.add('oui'); 
 		newspace.setAttribute("name" , "point[]");
